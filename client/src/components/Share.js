...
const Share = () => {
     ...
     const submitHandler = async (e) => {
          ...
          desc.current.value = '';  // Clear description
     };

     return (
          <div className='w-[100%]  h-auto rounded-[10px] shadow-md'>
               <div className='p-[10px]'>
                    <div className='flex items-center'>
                         <img
                    ...
                    <form className='flex items-center justify-between z-40 ' onSubmit={submitHandler}>
                         <div className='flex ml-[20px]'>
                              <label htmlFor='file' className='flex items-center mr-[15px] cursor-pointer'>
                                   <PermMedia htmlColor='tomato' className='text-[18px] mr-[3px]' />
                                   <span className='text-[14px] font-medium'>Photo or Video</span>
